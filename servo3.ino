/* Control de posición de servo usando un potenciómetro (resistor variable) by Sergio, Yenny, Michel, Marco. / 
...
servo1.attach(10); servo2.attach(9); // Fija el servo en el pin  9,10 al objeto servo1 y servo2 
...
servo1.write(80); // Ajusta la posición del servo de acuerdo con el valor escalado delay(150);
